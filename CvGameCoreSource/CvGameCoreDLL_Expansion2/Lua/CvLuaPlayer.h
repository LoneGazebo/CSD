...
protected:
	...
	static int lGetScienceRateFromMinorAllies(lua_State* L);
	static int lGetScienceRateFromLeagueAid(lua_State* L);
	static int lGetLeagueCultureCityModifier(lua_State* L);
#endif
	...
	static int lGetJerk(lua_State* L);
